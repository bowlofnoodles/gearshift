---
name: init
description: Use when a repository needs first-time Gearshift setup, canonical .gear files, managed routing guidance, or initialization repair.
---
...
If Standard or Full dependencies are missing, explain which gear needs each dependency and ask before installing anything. Do not install or upgrade third-party Skills without explicit approval.

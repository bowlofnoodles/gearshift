...
Gearshift is the top-level workflow controller. Route every coding request before Superpowers or other workflow frameworks.

## Routing Contract

1. If the user explicitly invokes Quick, Standard, or Full, that explicit gear wins. Load the matching Gearshift Skill immediately; do not classify again.
